      ...
      <div className="bg-white rounded-xl shadow-md overflow-hidden">
        <div className="px-6 py-4 bg-gradient-to-r from-red-600 to-red-700 text-white">
          <div className="flex items-center">
            ...
            <h2 className="text-xl font-bold">Visi Partneri ({partners.length})</h2>
          </div>
        </div>
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <input
                    type="color"
                    value={partnersSettings.titleAccentColor}
                    onChange={(e) => setPartnersSettings({...partnersSettings, titleAccentColor: e.target.value})}
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <input
                    type="color"
                    value={partnersSettings.ctaBgColor}
                    onChange={(e) => setPartnersSettings({...partnersSettings, ctaBgColor: e.target.value})}
                    className="h-10 w-20 rounded border border-gray-300 cursor-pointer"
                  />
                  <input
                    type="text"
